...
export function processJourneyMultichart(g2,g3,newState){
  let traffic ={ actual: [], target:[], lq: [], ly: []},
      conv = { actual: [], target:[], lq: [], ly: []},
      qtrrate = { actual: [], target:[], lq: [], ly: []},
      qtrpayment = { actual: [], target:[], lq: [], ly: []},
      newqfm = { actual: [], target:[], lq: [], ly: []},
      repeatuser = { actual: [], target:[], lq: [], ly: []},
      marketable = { actual: [], target:[], lq: [], ly: []},
      uqfm = { actual: [], target:[], lq: [], ly: []},
      paidspend = { actual: [], target:[], lq: [], ly: []},
      paidsource = { actual: [], target:[], lq: [], ly: []},
      newuqfm = { actual: [], target:[], lq: [], ly: []};
