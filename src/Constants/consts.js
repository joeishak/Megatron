...
export const SUMMARY_KPIS = {
    ...
    BUY_MARKETING_SOURCED: 18,
    BUY_LTV_ROI: 19,
    BUY_WEB_ORDERS: 20,
    BUY_CONVERSION: 21,
    BUY_PAID_MEDIASPEND: 22,
    
    USE_PERCENT_ACTIVATED: 23,
    USE_WK4_WAU_RATE: 24,
    USE_MONTH_RETURN_RATE: 25,
    USE_LOW_CEI: 26,
    USE_MEDIUM_CEI: 27,
    USE_HIGH_CEI: 28,
    USE_0_INACTIVE_CEI: 29,
    USE_REPEAT_USER_MAU: 30,
    RENEW_CANCEL: 31,
    RENEW_CANCEL_ADOBECOM: 32,
    RENEW_QTR_FIN: 33,
    RENEW_QTR_UI: 34,
    RENEW_QTR_PF: 35,
    RENEW_CANCEL_RESLLER_E: 36,
    RENEW_EOT_RESELLER: 37,
    RENEW_QTR_FIN_RETAIL: 38
};
